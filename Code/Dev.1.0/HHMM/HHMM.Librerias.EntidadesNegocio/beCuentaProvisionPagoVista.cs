...
{
    public class beCuentaProvisionPagoVista
    {
        ...
        public string ComponenteArticulo { get; set; }
		...
		public string PlanCuentaContableVcostoDesc { get; set; }
		public string PlanCuentaContableVprovDesc { get; set; }
		public string PlanCuentaContableVcliDesc { get; set; }
		public string PlanCuentaContableNVcostoDesc { get; set; }
		public string PlanCuentaContableNVprovDesc { get; set; }
		public string PlanCuentaContableNVcliDesc { get; set; }
